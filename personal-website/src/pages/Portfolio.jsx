const projects = [
  {
    title: "Wazigov",
    description: "A mobile app that empowers citizens to report corruption incidents anonymously. It features a user-friendly interface, secure data handling, and real-time updates on reported cases.",
    links: [
      { label: "Slide deck", url: "https://docs.google.com/presentation/d/1atnZ7MTAq5WRFlaATSM1LYvjCx2f00e1-fi77gsLbPI/edit?usp=drive_link" },
